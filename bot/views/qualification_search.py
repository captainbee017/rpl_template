...
from bot.models import PUBLISHED, Qualification, QualificationCategory
...
class QualificationSearch(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        ctx['query_text'] = self.request.GET.get('query', None)
        ctx['qualification_categories'] = QualificationCategory.objects.all()
        return ctx
    ...
    def get_objects(self):
        ...
        if lookup_query:
            ...
            results = Qualification.objects.none()
        return results
    ...
    def get_searchbar_filters(self):
        ...
        query_str = self.request.GET.get('query', None)
        if query_str:
